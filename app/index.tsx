...
// ==== 2. Konstanta dan Konfigurasi Layout ====
...
export default function ImageGrid() {
  // State untuk mengelola setiap gambar secara individual
  ...
  const handleClick = (index: number) => {
    ...
    setStates((prevStates) =>
      prevStates.map((item, i) => {
        // Hanya ubah state gambar yang diklik dan belum mencapai batas klik
        ...
        // ✅ IMPLEMENTASI: Penskalaan bertahap berdasarkan jumlah klik
        if (nextClick === 2) newScale = 1.2;
        if (nextClick === 3) newScale = 2.0; // ✅ IMPLEMENTASI: Batas maksimum 2x

        return {
          clickCount: nextClick,
          isAlt: true, // Ganti ke gambar alternatif setelah klik pertama
          scale: newScale,
        };
      })
    );
      ...
      {images.map((img, index) => {
        ...
        return (
          <TouchableOpacity
            ...
            style={styles.cell}
            activeOpacity={0.8}
            // ✅ IMPLEMENTASI: Tombol dinonaktifkan setelah mencapai batas
